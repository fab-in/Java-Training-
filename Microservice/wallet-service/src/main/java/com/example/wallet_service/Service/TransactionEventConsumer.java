 ...
 * Listens for OTP verification events from Transaction Service
 */
@Service
public class TransactionEventConsumer {
    ...
    /**
     * Consumes OTP verified events from Transaction Service
     * Processes the transaction by updating wallet balances
     */
